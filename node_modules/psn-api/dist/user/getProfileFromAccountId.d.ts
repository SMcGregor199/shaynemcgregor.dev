 ...
 */
export declare const getProfileFromAccountId: (authorization: AuthorizationPayload, accountId: string, options?: GetProfileFromAccountIdOptions | undefined) => Promise<ProfileFromAccountIdResponse>;
export {};
