 ...
 */
export declare const getUserFriendsAccountIds: (authorization: AuthorizationPayload, accountId: string, options?: Partial<GetUserFriendsAccountIdsOptions> | undefined) => Promise<GetUserFriendsAccountIdsResponse>;
export {};
