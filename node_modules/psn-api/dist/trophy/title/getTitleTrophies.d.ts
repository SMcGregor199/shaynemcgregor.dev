 ...
 */
export declare const getTitleTrophies: (authorization: AuthorizationPayload, npCommunicationId: string, trophyGroupId: string, options?: Partial<GetTitleTrophiesOptions> | undefined) => Promise<TitleTrophiesResponse>;
export {};
