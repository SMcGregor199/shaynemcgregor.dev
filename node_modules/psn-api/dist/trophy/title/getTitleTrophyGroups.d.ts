 ...
 */
export declare const getTitleTrophyGroups: (authorization: AuthorizationPayload, npCommunicationId: string, options?: Partial<GetTitleTrophyGroupsOptions> | undefined) => Promise<TitleTrophyGroupsResponse>;
export {};
