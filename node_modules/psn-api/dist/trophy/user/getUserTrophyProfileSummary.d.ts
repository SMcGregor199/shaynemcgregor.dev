 ...
 */
export declare const getUserTrophyProfileSummary: (authorization: AuthorizationPayload, accountId: string, options?: Partial<GetUserTrophyProfileSummaryOptions> | undefined) => Promise<UserTrophyProfileSummaryResponse>;
export {};
