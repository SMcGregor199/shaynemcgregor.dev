 ...
 */
export declare const getUserTrophyGroupEarningsForTitle: (authorization: AuthorizationPayload, accountId: string, npCommunicationId: string, options?: Partial<GetUserTrophyGroupEarningsForTitleOptions> | undefined) => Promise<UserTrophyGroupEarningsForTitleResponse>;
export {};
