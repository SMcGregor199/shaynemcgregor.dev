 ...
 */
export declare const getUserTrophiesEarnedForTitle: (authorization: AuthorizationPayload, accountId: string, npCommunicationId: string, trophyGroupId: string, options?: Partial<GetUserTrophiesEarnedForTitleOptions> | undefined) => Promise<UserTrophiesEarnedForTitleResponse>;
export {};
