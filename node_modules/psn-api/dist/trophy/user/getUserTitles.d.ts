 ...
 */
export declare const getUserTitles: (authorization: AuthorizationPayload, accountId: string, options?: Partial<GetUserTitlesOptions> | undefined) => Promise<UserTitlesResponse>;
export {};
