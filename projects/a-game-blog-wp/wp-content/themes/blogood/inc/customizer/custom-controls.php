 ...
 */
class  Blogood_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class  Blogood_Dropdown_Category_Control extends WP_Customize_Control {
...
class  Blogood_Note_Control extends WP_Customize_Control {
...
class  Blogood_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  Blogood_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogood-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class  Blogood_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogood-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( (string) $this->value(), (string) $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class  Blogood_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class  Blogood_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="blogood-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>
	        <li>
	            <input class="blogood-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu blogood-drag-handle"></i>
	        </li>
        ...
        <li class="sortable-hideme">
          <input class="blogood-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
Class  Blogood_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class  Blogood_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class  Blogood_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="blogood-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'blogood' ); ?>" class="blogood-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}

class Blogood_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
